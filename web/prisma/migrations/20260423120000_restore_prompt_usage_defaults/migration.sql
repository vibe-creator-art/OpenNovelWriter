ALTER TABLE "Prompt" ADD COLUMN "allowLlmCall" BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE "Prompt" ADD COLUMN "allowAgentCall" BOOLEAN NOT NULL DEFAULT false;
ALTER TABLE "Prompt" ADD COLUMN "agentCallMode" TEXT NOT NULL DEFAULT 'generate_then_agent';
