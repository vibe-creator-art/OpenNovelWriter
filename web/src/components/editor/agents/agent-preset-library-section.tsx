...
type AgentPresetLibrarySectionProps = {
...
export function AgentPresetLibrarySection({
    presets,
    loading,
    error,
    cloningPresetId,
    ...
    className,
}: AgentPresetLibrarySectionProps) {
    const t = useTranslations('agents')
    const [expanded, setExpanded] = useState(false)

    if (!loading && !error && presets.length === 0) return null
