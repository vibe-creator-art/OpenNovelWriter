...
// Source: cherry-studio/src/shared/utils/model.ts
...
import { MODALITY, VENDOR_PATTERNS } from '../runtime/shared-model-types'
import type { Model, RuntimeReasoning, ThinkingTokenLimits } from '../runtime/shared-model-types'
import { MODEL_CAPABILITY, parseUniqueModelId } from '../runtime/shared-model-types'
