...
- npm
- Git
- [OpenAI Codex CLI](https://github.com/openai/codex)（Codex 会话功能依赖本机的 `codex` 命令，需安装并完成登录）
...
- npm
- Git
- [OpenAI Codex CLI](https://github.com/openai/codex) (Codex session features invoke the local `codex` command; install it and sign in first)
